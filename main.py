...
# ROUTE TO PROCESS AND VALIDATE THE FORM

@app.route("/", methods=['POST'])
def user_signup_complete():

    # initials var from inputs
    ...
    # IF NO ERRORS > WELCOME.HTML
    # IF THERE ARE ERRORS, THIS WILL STAY ON THE INDEX.HTML AND DISPLAY THE ERROR MSGS
